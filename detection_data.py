...
# add channel = 1 to the last new dimension
x_trainT1 = x_trainT1[:,:,:,np.newaxis]
x_valT1 = x_valT1[:,:,:,np.newaxis]
x_trainT2 = x_trainT2[:,:,:,np.newaxis]
x_valT2 = x_valT2[:,:,:,np.newaxis]
